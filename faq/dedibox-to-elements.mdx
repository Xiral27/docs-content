...
If you already have a Scaleway account, you must be the [Owner](/console/my-project/concepts/#owner) of the [Organization](/identity-and-access-management/iam/concepts/#organization) you would like to link your Dedibox account to.
...
| **STORAGE MANAGEMENT** | RPN-SAN                              | Order and manage your RPN-SAN                                                                                           | Q4 2022       |
...
| **BILLING**            | Payment method Management (SEPA, CB) | Manage your Scaleway payment methods (SEPA, CB) in one single place                                                     | Q1 2023       |
|                        | Invoices consultation                | Consult your invoices for your Dedibox servers or services                                                              | Q4 2022       |
|                        | Payment management                   | Pay for your Scaleway products with one default payment method                                                          | Q1 2023       |
...
You will continue to receive an invoice for each type of product (one for Dedibox and one for Scaleway Elements products).
However, the default payment method defined in the Elements console will allow you to pay all your Scaleway invoices (Dedibox and Elements). It is important that you verify the default payment method defined in the Scaleway console after the linking process, to ensure the proper payment method will be used for your future invoices.<br />

## Where can I find my Dedibox invoices, following the linking of my accounts?

You will be able to find all your invoices in the Billing section of the Elements console (old Dedibox invoices as well as all new invoices).

## Following the linking of my accounts, will I find my Dedibox payment methods in the Elements console?

All your active Dedibox payment methods will be migrated to Elements during the linking process so that you will be able to manage them from the Elements console instead of the Dedibox console.<br />
You will also have to choose a unique default payment method for your Scaleway services. This default payment method will allow you to pay all of your Scaleway invoices (Elements and Dedibox).
...
For the first customers following the linking process, a discount of 100€ is applied directly to their Scaleway Elements account. This discount is valid for six months after the link of your accounts. It is available on our Scaleway Elements cloud services ordered through the Scaleway console, excluding DDX and Elastic Metal products.
