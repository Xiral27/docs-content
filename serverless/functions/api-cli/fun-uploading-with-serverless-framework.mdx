...
- `scwToken`: the Scaleway **API token** you got in the requirements section.
...
- `functions`: configuration of your functions. It is a `yml` dictionary, with the key being the functions' name.
  ...
  - `secret` (Optional): secret environment variables specific to the current function.
  ...
  - `custom_domains` (Optional): list of custom domains, refer to the [how to add a custom domain](/serverless/functions/how-to/add-a-custom-domain-name-to-a-function/) documentation page.
...
<Message type="note">
  For more detail on how to package your dependencies please refer to [How to package your function and upload it as a Zip](/serverless/functions/how-to/package-function-in-zip/).
</Message>
...
For further details, see the [Serverless Scaleway plugin Node 16 example](https://github.com/scaleway/serverless-scaleway-functions/tree/master/examples/nodejs).
...
For further details, see the [Serverless Scaleway plugin Python 3 example](https://github.com/scaleway/serverless-scaleway-functions/tree/master/examples/python3).
...
For further details, see the [Serverless Scaleway plugin Go 1.17 example](https://github.com/scaleway/serverless-scaleway-functions/tree/master/examples/go).
...
For further details, see the [Serverless Scaleway plugin Golang 1.13 example](https://github.com/scaleway/serverless-scaleway-functions/tree/master/examples/go113).
...
```
The `composer.json` files enable you to define dependencies that will be installed when deploying your functions, for more information, you can check the [official documentation](https://getcomposer.org/doc/04-schema.md/#package-links) of composer
For further details, see the [Serverless Scaleway PHP example](https://github.com/scaleway/serverless-scaleway-functions/tree/master/examples/php).
...
For further details, see the [Serverless Scaleway Rust example](https://github.com/scaleway/serverless-scaleway-functions/tree/master/examples/rust).
