...
For this example we will use Scaleway SDK and Scaleway console, for more information please refer to the [Python SDK Documentation](https://github.com/scaleway/python-scaleway) and the [package your function and upload it as a zip-file page](https://www.scaleway.com/en/docs/serverless/functions/how-to/package-function-in-zip/) how to.
...
To go further, refer to our [Terraform](https://www.scaleway.com/en/docs/tutorials/terraform-quickstart/) and [Serverless Functions](https://www.scaleway.com/en/docs/serverless/functions/quickstart/) documentation.