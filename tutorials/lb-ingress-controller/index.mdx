...
To demonstrate how it works, we will use a test application called `cafe-ingress`, you can find it at this [URL](https://github.com/AliyunContainerService/serverless-k8s-examples/blob/master/ingress-nginx/ingress-cafe-demo.yaml). It's a pretty simple application just serving different web pages depending on the URL you type.
...
To create a secret key please use the following [tutorial](/identity-and-access-management/iam/how-to/manage-api-keys/):
