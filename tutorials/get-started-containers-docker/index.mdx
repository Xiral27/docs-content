...
2. Follow [these instructions](https://www.scaleway.com/en/docs/containers/container-registry/how-to/create-namespace/) to create a namespace. Make sure that you set your privacy policy to **private**.
...
3. Log in to your Container Registry namespace:
    ...
    <Message type="tip">
      Ensure that you replace `<address-of-your-namespace>` with the address of your own Container Registry namespace (e.g. `rg.fr-par.scw.cloud/mynamespace`) and that you have [created your API key](/identity-and-access-management/iam/how-to/manage-api-keys/) and that you have saved the secret part of your API key as an environment variable e.g. with the command `export SCW_SECRET_TOKEN=a4db08b7-5723-4ba9-8c18-f2de493465a2`
    </Message>
...
- [Kubernetes Concepts](https://www.scaleway.com/en/docs/containers/kubernetes/concepts/)
- [Introduction to Kubernetes](https://www.scaleway.com/en/docs/containers/kubernetes/reference-content/introduction-to-kubernetes/)
