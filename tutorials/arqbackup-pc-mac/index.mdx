...
8. Enter the Object Storage credentials:
    ...
    - **Access Key ID:** The [Access Key](/identity-and-access-management/iam/how-to/manage-api-keys/) of the API key used for authentication
    - **Secret Key:** The [Secret Key](/identity-and-access-management/iam/how-to/manage-api-keys/) of the API key used for authentication
