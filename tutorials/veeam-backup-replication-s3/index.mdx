...
9. Click **Add** (1) to enter the [API key](/identity-and-access-management/iam/how-to/manage-api-keys/) (2) related to the bucket. Optionally a description can be provided:
