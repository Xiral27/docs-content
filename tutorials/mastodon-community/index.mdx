...
5. Select **Amazon S3** as a service provider to set up Mastodon with Object Storage. Valid [API keys](/identity-and-access-management/iam/how-to/manage-api-keys/) are required in this step.
